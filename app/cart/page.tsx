  ...
  return (
    <main className="section page-enter">
      <div className="container reveal">
        ...
        <div
          style={{
            backgroundColor: cart.isFreeShipping ? "#f0fdf4" : "#eff6ff",
            border: `1px solid ${cart.isFreeShipping ? "#bbf7d0" : "#bfdbfe"}`,
            color: cart.isFreeShipping ? "#15803d" : "#1e40af",
            padding: "12px 16px",
            borderRadius: "8px",
            fontSize: 14,
            fontWeight: 600,
        ...
        >
          {cart.isFreeShipping ? (
            ...
            <>🚚 Add <strong>₹{cart.remainingForFreeShipping}</strong> more to get <strong>FREE Shipping</strong></>
          )}
        </div>
          ...
          <aside className="card pad shop-sidebar">
            ...
            <div style={{ display: "grid", gap: 12, fontSize: 15, color: "var(--muted)" }}>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <span>Subtotal</span>
                <span style={{ fontWeight: 600, color: "var(--ink)" }}>₹{cart.subtotal}</span>
              </div>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <span>Shipping</span>
                {cart.isFreeShipping ? (
                  ...
                  <span style={{ fontWeight: 600, color: "var(--ink)" }}>₹{cart.shippingCharge}</span>
                )}
              </div>
              <div
                style={{
              ...
              >
                <span>Total</span>
                <span style={{ color: "var(--sage-dark)" }}>₹{cart.total}</span>
              </div>
            </div>
